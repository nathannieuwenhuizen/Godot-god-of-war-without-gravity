...
#             newFileName = "demo/bin" + basename + ".gdns"

#             if not os.path.isfile(newFileName):
#                 newfiles.Append(basename)

#                 gdnsFile = open("./demo/bin/" + basename + ".gdns", "w")
#                 gdnsFile.write(gdns)
#                 gdnsFile.close()
#         # gdns

# with open("./src.gdlibary.cpp", '+') as f:
#     for line in f:
#         if not line.contains("godot::Godot::nativescript_init(handle);"):
#             continue
